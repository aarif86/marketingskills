// Tiny zero-dependency ZIP writer (deflate). Used for admin evidence downloads; small archives only (in memory).
...
export function zipBuffer(entries) {
  ...
  for (const e of entries) {
    ...
    central.writeUInt32LE(0x02014b50, 0); central.writeUInt16LE(0x031e, 4); central.writeUInt16LE(20, 6); central.writeUInt16LE(0x0800, 8); central.writeUInt16LE(8, 10);
